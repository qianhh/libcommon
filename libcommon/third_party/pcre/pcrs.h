...
extern char *pcrs_subsitute_command(const char *subject, const char *pcrs_command, int *hits);

extern int pcrs_match_command(const char *subject, const char *pcre_command,const char* pcre_option,char **result, size_t *result_position);
